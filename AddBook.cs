...
namespace project
{
    public partial class AddBook : Form
    {
        ...
        {
            InitializeComponent();
            bookList = new BookLinkedList();  // Initialize the linked list
        }
        ...
        private void Save()
        {
            if (bnametxt.Text != "" && bauthortxt.Text != "" && bpubtxt.Text != "" && bdatetxt.Text != "" && bpricetxt.Text != "" && bquantitytxt.Text != "")
            {
                ...
                Book newBook = new Book(bookName, bookAuthorName, bookPublication, bookPrice, bookQuantity, bookPurchaseDate);
                // Insert the new book into the linked list
