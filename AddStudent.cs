...
namespace project
{
    public partial class AddStudent : Form
    {
        ...
        private void Save()
        {
            ...
            // Validate input
            if (string.IsNullOrWhiteSpace(name) || string.IsNullOrWhiteSpace(enroll) ||
                string.IsNullOrWhiteSpace(dep) || string.IsNullOrWhiteSpace(sem) ||
            ...
            //insertion
            studentList.InsertStudent(name, enroll, dep, sem, mobile, email);
